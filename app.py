...
img101 = '/home/priyanshu/Desktop/Self_HTR/data/page/r06-137.png'
########################################################################################################
##########################   Here is text detection part  ##############################################

global path
path = 'test_images' + random.choice(string.ascii_letters) + random.choice(string.ascii_letters) +random.choice(string.ascii_letters) +random.choice(string.ascii_letters)
...
base_image_path = os.path.join(base_path, path)
